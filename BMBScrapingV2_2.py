...
class scraping():
    ...
    def __init__(self):
        ...
        self.__url_cuenta = "https://www.bullmarketbrokers.com/Operations/StockAccountQueries/GetScreen"
    ...
    def login(self, email, password):
        ...
        login = self.s.post(self.__url_login, data = data_login)
    ...
    def cotizaciones(self, mercado, term=3):
        ...
        data = {
                "_ts": str(int(datetime.timestamp(datetime.now()))),
                "term": str(term),
                "index": "",
                "sortColumn": "ticker",
                "isAscending": "true"
        ...
        datos = self.__get_data(url, data)
        datos = datos["result"]
        
        return datos
        
    def cuenta(self, cuenta):
        url = self.__url_cuenta
        data = {"stockAccountNumber": int(cuenta)}
